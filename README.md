...
## Original hol-sse-websocket repository

Original hol-sse-websocket repository (Hands-on-lab on using server-sent events and web socket with Jersey and Tyrus) has been moved under JavaEE organization on GitHub [6].
...
* [6] https://github.com/javaee/jersey-hol-sse-websocket
